...
**Utolsó frissítés:** 2026-09-24 (Ziggurat: kollégafiókok, név- és állapotírás — lásd 7.0)
...
| **⚠️ RLS-javítás:** az alkalmazás kapcsolatai megkapják a telephelyet | ✅ `siduri_app`-ként is | `HATRALEK.md` |
...
| **Készlet S2 — motor** a telephelyen: mozgás, egyenleg, mozgóátlagár (negatív bázis), levonás a lezáráskor a (többszintű) receptből, sztornó, megosztás, pult → raktár; bevételezés csomag-átváltással, átadás, selejt, személyzeti, előállítás | ✅ tesztekkel, 7 mutációs próbával | `KESZLET.md` 3/a, `admin/1.23.0`, V39 |
...
**Tesztszámok (mérve):** mag 202 · k2 21 · felhő 210 · telephely 449 · felület 58 · pult 160.
...
| **Alapból létrehozott kategóriák** *(a felhasználó kérése)* | **Termék 5% · Termék 18% · Termék 27% · TAM · AJT · AAM · Szerviz 5% · Szerviz 18% · Szerviz 27%** — kilenc; a nyolc rögzített gyűjtő (G1) + az AAM | — |
| **Az AAM gyűjtője** | ⚠️ saját rekesz nincs (a pénztárgép és az NTAK is öt termékkódot ismer, H5) → az **„E” (0%)** gyűjtőre kerül, a TAM mellé | **jogi kérdés**: TAM ≠ AAM — a könyvelőnek feltéve (KONYVELOI_KERDESEK B7); ha más kell, csak ennek a kategóriának a gyűjtője változik |
...
9. ✅ **A monoton óra azonosítója.** `kassza` v1.22.0, V21 migráció.

   ⚠️ **CSENDES HIBA VOLT, AMI SZOLGÁLAT KÖZBEN ZÁRTA VOLNA LE A NAPOT.** A
   munkanap hosszát két órán mérjük, és a nagyobbik dönt. A monoton mérés két
   nyers számláló-érték különbsége volt, és semmi nem nézte, hogy **ugyanaz az
   óra** mérte-e őket. Egy tartalék szerver vagy másik gép számlálójával egy
   nyolcórás nap „napokig tartónak" látszott → vészzárás. A javítás előtt
   teszttel bizonyítva. Részletesen: `MERESEK.md`, M36.
