...
| **W4** | **A felhő rendelkezésre állási vállalása** a törzsadat-karbantartásra *(13.5)*. **Bemenet megvan (2026-09-21, `NYITOTT_KERDESEK.md` B17/b): két gép, vállaltan aszinkron** — tehát **kimaradás nincs, de failovernél néhány másodperc írás elveszhet**, és ezt a vállalásnak ki kell mondania. A veszteségablak **mérendő** (`M5`) |
